<div id="modal-default-updatecustomer{{$customer->id}}" class="modal" tabindex="-1" aria-hidden="true">
	<div class="modal-dialog">
		<form method="POST" action="{!! route('customer.update', array($customer->id)) !!}"> 
			{{method_field('PUT')}}
			@csrf
		<div class="modal-content">
			<!-- BEGIN: Modal Header -->
			<div class="modal-header">
				<h2 class="font-medium text-base mr-auto">Update Customer</h2>
			</div>
			<!-- END: Modal Header -->
			<!-- BEGIN: Modal Body -->
			<div class="modal-body grid grid-cols-24 gap-4 gap-y-3">
				...
				<div class="col-span-12 sm:col-span-6">
					...
					<input id="email" name="identity_no" type="text" class="form-control" value="{{ $customer->identity_no }}">
				</div>
				<div class="col-span-12 sm:col-span-6">
					<label for="modal-form-3" class="form-label">Address Line 1</label>
					<input id="address_line_1" name="address_line_1" type="text" class="form-control" value="{{ $customer->address_line_1 }}">
				</div>
				<div class="col-span-12 sm:col-span-6">
					<label for="modal-form-3" class="form-label">Address Line 2</label>
					<input id="address_line_2" name="address_line_2" type="text" class="form-control" value="{{ $customer->address_line_2 }}">
				</div>
				<div class="col-span-12 sm:col-span-6">
					<label for="modal-form-4" class="form-label">County</label>
					<input id="county" name="county" type="text" class="form-control" value="{{ $customer->county }}">
				</div>
				<div class="col-span-12 sm:col-span-6">
				...
				<div class="col-span-12 sm:col-span-6">
					...
					<input id="country" name="country" type="text" class="form-control" value="{{ $customer->country }}">
				</div>
				<div class="col-span-12 sm:col-span-6">
					<label for="modal-form-5" class="form-label">Mobile No</label>
					<input id="mobile_no" name="mobile_no" type="text" class="form-control" value="{{ $customer->mobile_no }}">
				</div>
				<div class="col-span-12 sm:col-span-6">
				...
				<div class="col-span-12 sm:col-span-6">
					...
					<select id="modal-form-6" name="status_id" class="form-select">
						<option value="{{ $customer->status->id }}">{{ $customer->status->status }}</option>
